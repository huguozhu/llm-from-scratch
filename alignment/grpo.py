...
# ==============================================================================
# 功能概述：
#   实现 Group Relative Policy Optimization（GRPO），DeepSeek-R1 的核心 RL 算法。
#   对每个问题生成 G 个候选回答，组内相对比较计算优势函数，
#   PPO clip 限制更新幅度，KL 散度惩罚防止偏离参考模型。
#   奖励：格式奖励（<think> 标签 + \\boxed{} 格式）+ 正确性奖励（答案匹配）
# ==============================================================================
