...
# ==============================================================================
# 功能概述：
#   定义 SFT（监督微调）和 RL（强化学习）训练的命令行参数。
#   - get_sft_parser() : SFT 参数（模型、学习率、epoch、梯度累积、数据集等）
#   - get_rl_parser()  : RL/GRPO 参数（继承 SFT + KL 系数、采样组大小等）
#   SFT 训练数据：HuggingFace GSM8K 数学推理数据集
# ==============================================================================
import argparse
